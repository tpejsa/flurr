...
public:
  ...
  void destroyNode(FlurrHandle a_nodeHandle);
  void destroyNode(const std::string& a_nodeName);
  ...
  std::vector<FlurrHandle> getAllComponentHandlesOfType(NodeComponentType a_componentType);
